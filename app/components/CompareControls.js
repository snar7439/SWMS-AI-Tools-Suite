...
export default function CompareControls({ 
  ...
  const canCompare = selectedDocuments && selectedDocuments[0] && selectedDocuments[1];
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="px-4 py-2 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
            Clear Selection
          </button>
      ...
      {isComparing && (
        <div className="mt-4">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-2 text-center">
            Analyzing reports for differences...
          </p>
        </div>
      )}
    </div>
