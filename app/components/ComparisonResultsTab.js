        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
            ...
            <div className="space-y-2 text-sm">
              <div><span className="font-medium">Name:</span> {selectedReports[0].name}</div>
              <div><span className="font-medium">Type:</span> {selectedReports[0].type}</div>
              <div><span className="font-medium">Size:</span> {selectedReports[0].size}</div>
              <div><span className="font-medium">Modified:</span> {selectedReports[0].lastModified}</div>
            </div>
          </div>
          ...
          <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
            ...
            <div className="space-y-2 text-sm">
              <div><span className="font-medium">Name:</span> {selectedReports[1].name}</div>
              <div><span className="font-medium">Type:</span> {selectedReports[1].type}</div>
              <div><span className="font-medium">Size:</span> {selectedReports[1].size}</div>
              <div><span className="font-medium">Modified:</span> {selectedReports[1].lastModified}</div>
            </div>
          </div>
        </div>
